...
[cerebrium.runtime.python.dependencies.pip]
fastapi = "latest"
uvicorn = "latest"
```
...
[cerebrium.runtime.cortex.dependencies.conda]
cuda = ">=11.7"
cudatoolkit = "11.7"

[cerebrium.runtime.cortex.dependencies.paths]
...
<Warning>
**Deprecated:** Top-level `[cerebrium.dependencies.*]` sections are deprecated.
Please move your dependencies to `[cerebrium.runtime.{runtime_type}.dependencies.*]`.
...
<Warning>
  ...
  backwards compatibility. We recommend migrating to the new runtime sections.
</Warning>
...
### Deprecated: Top-level [cerebrium.dependencies.*]
...
| ---------------------------------- | ------------------------------------------------------ |
| `[cerebrium.dependencies.pip]`     | `[cerebrium.runtime.{type}.dependencies.pip]`          |
| `[cerebrium.dependencies.apt]`     | `[cerebrium.runtime.{type}.dependencies.apt]`          |
| `[cerebrium.dependencies.conda]`   | `[cerebrium.runtime.{type}.dependencies.conda]`        |
| `[cerebrium.dependencies.paths]`   | `[cerebrium.runtime.{type}.dependencies.paths]`        |
