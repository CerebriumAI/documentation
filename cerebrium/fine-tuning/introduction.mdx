...
<Note>Cerebrium's fine-tuning functionality is in public beta and so we are adding more functionality each week! Currently we only support the 
training of CasualLM models. If you have a urgent requirement, we can help you just reach out to [support](mailto\:support@cerebrium.ai)</Note>
...
Currently, our fine-tuning capabilities are limited to any causal language models from the HuggingFace transformers library. Some of these models include:
