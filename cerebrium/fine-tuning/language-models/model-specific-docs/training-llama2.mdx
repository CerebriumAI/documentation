...
Fine-tuning Llama2 on Cerebrium is simple and easy.  
Once you have access to the Llama2 model weights, you can quickly finetune it on Cerebrium with just one CLI command!
