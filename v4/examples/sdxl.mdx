...
To see the final implementation, you can view it [here](https://github.com/CerebriumAI/examples/tree/master/5-image-and-video/2-sdxl-refiner)
...
```curl
curl --location 'https://api.cortex.cerebrium.ai/v4/p-<YOUR PROJECT ID>/2-sdxl-refiner/predict' \
