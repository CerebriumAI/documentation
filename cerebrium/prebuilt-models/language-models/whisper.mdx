...
Once you've deployed a Whisper model, you can supply the endpoint with a base-64 encoded audio file.  Here's an example of how to call the deployed endpoint:
