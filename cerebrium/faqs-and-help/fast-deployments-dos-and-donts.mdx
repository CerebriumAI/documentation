...
- **Do** make sure you utilise [persistent storage](/cerebrium/cortex/advanced-functionality/persistent-storage.mdx).
...
- **Do** ensure you take advantage of resources if available. Ensure that your model is running on the GPU if availible with:  
