...
Well we strive to lower cold start times and improve model loading onto the GPU, it might be beneficial to keep containers warm in order to handle incoming requests.
...
You set this using the **cooldown** parameter in your config.yaml and is by default set to 60 seconds. This is the amount of seconds of inactivity from when your last
