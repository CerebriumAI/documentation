---
title: "Using Secrets"
description: "Store API keys and third-party credentials as encrypted secrets on Cerebrium and inject them into apps as environment variables in every region."
---
