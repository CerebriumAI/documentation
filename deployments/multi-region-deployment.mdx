...
<Warning>
  Multi-region deployment is currently in **beta**. Cerebrium will make rapid
  updates and improvements over the next few months to bring full functionality
  to life. Reach out on [Discord](https://discord.gg/ATj6USmeE2) about
