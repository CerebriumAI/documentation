...
Cerebrium supports Tensorflow, Keras and TFLite through its support for ONNX - we will convert our model from Tensorflow to ONNX.
...
Copy and paste our code below. This creates a simple 3-layer Neural Network that classifies flowers from the Iris dataset into 1 of 3 classes.
This code could be replaced by any Tensorflow model.
...
deployed. You will see an API call was made and the inference time. From your dashboard, you can monitor your model, roll back to previous versions and see
traffic.
