...
We can then deploy our model to an RTX_A5000 instance with the following line of code

```bash
cerebrium deploy segment-anything --hardware RTX_A5000 --api-key private-XXXXXXXXXXXXX
```
