...
|               | num_validation_inference_steps    | 25              | number of inference steps when generating inference images                                                         |
|               | gradient_accumulation_steps       | 1               | Number of gradient accumulation steps.                                                                             |
|               | learning_rate                     | 1.0E-5          | The learning rate you would like to train with. Can be more aggressive than you would use to train a full network. |
...
|               | mixed_precision                   | ~               | If you would like to use mixed precision. Supports fp16 and bf16 else train in fp32 by default. Use with caution.  |
...
prior_class_prompt: "INSERT YOUR PRIOR CLASS PROMPT HERE"
...
training_args:
  ...
  allow_tf32: False
  max_grad_norm: 1.0
  mixed_precision: ~ # If you would like to use mixed precision. Supports fp16 and bf16 else train in fp32.
