...
Please move your dependencies to `[runtime.{type}.dependencies.*]`.
...
<Note>
The `[dependencies.paths]` section has been replaced with `_file_relative_path` key inside dependency maps. See the Dependencies section above for the new syntax.
</Note>
