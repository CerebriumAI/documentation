...
description: "Migrate workloads from Replicate to Cerebrium in under 5 minutes using SDXL-Lightning-4step as a worked example for faster, cheaper inference."
---
...
- [Faster cold starts](/performance/faster-cold-starts)
