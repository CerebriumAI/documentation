...
To see the final implementation, you can view it [here](https://github.com/CerebriumAI/examples/tree/master/3-advanced-concepts/1-faster-inference-with-vllm)
