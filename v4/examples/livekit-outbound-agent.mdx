...
We need to specify our Cerebrium environment to deploy our app. We will be doing this using a Dockerfile:
...
Above we simply define our hardware, scaling parameters, dependancies as well as the port and Dockerfile to run our application.
