...
Without SIGTERM handling in a custom runtime, Cerebrium terminates containers immediately after sending `SIGTERM`, which interrupts in-flight requests and causes **502 errors**.
