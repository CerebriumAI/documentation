...
This will setup our environment by installing our Python packages and will deploy our training script to be a endpoint that should be returned at the end of the deployment process. **_Copy this POST url_** - we will need it later.
