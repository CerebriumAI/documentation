...
- <u>Model initialization</u>: This part of your code is outside of your
  functions function and only runs when your app incurs a cold start. You are
  charged for the amount of time it takes for this code to run. Typically this
  is loading a model into GPU RAM, loading python packages etc.
