...
You can do this by clicking on the <b>New Project</b> button in the top right corner of the screen.
...
Note your dataset _must_ contain a timestamp column. This is used to track the performance of your model over time.
