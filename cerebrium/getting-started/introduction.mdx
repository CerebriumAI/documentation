...
<Info>
  ...
  structure. When launching new instances, it pulls only the specific files and
  layers needed. This targeted approach significantly reduces cold start times
