...
Instantiate a Censius Client and register a dataset in the project you previously created:
...
Once you have instantiated your conduit object in code, you can add a Censius logger to it by calling the `add_logger` method.
