...
To see the final implementation, you can view it [here](https://github.com/CerebriumAI/examples/tree/master/2-advanced-concepts/2-faster-inference-with-vllm)
...
```
cerebrium init 2-faster-inference-with-vllm
```
...
```curl
curl --location --request POST 'https://api.cortex.cerebrium.ai/v4/p-<YOUR PROJECT ID>/2-faster-inference-with-vllm/predict' \
