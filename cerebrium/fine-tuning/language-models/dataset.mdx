...
Due to the much lower number of trainable parameters, the datasets used do not need to be greater than 1000 examples however, its always best to use as many, diverse training examples as possible to cover a wide variety of use cases.

As mentioned, we are initially using the [Alpaca-Lora format](https://github.com/TianyiPeng/alpaca-lora/tree/main/templates) as our
