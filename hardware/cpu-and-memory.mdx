...
description: Configure CPU cores and memory for Cerebrium apps, set sensible defaults, and pick CPU-only compute for lightweight, non-GPU inference workloads.
---
