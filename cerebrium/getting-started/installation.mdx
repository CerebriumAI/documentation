...
in Notebooks or .py files, we want you to feel comfortable and be environment agnostic."
---
...
You can verify your installation by running `cerebrium --help` in your terminal. If you don't get any output,
...
This should open up your web browser to the Cerebrium dashboard. If you haven't created an account, please sign up otherwise if you're already logged in, it should authenticate automatically,
