...
At the moment, we only support custom Dreambooth models that are hosted on Hugging Face. If you need help on how to train and deploy your model, you can read our blog post [here](https://www.cerebrium.ai/blog/creating-avatarai-me-using-supabase-and-cerebrium).
...
<ParamField body="hf_model_path" type="string" required>
