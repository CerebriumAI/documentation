...
<Note>
  This feature is available on all model types: custom & pre-built. If you have
  any questions on how to use it please reach out to us on Slack, Discord or{" "}
...
<Note>
  Make sure that the "webhook_endpoint" provided is able to handle POST requests
  and has the appropriate configuration to receive the response data.
</Note>
