...
might need such as user interruptions, dealing with audio data etc. We will show this functionality by joining a meeting room with our voice agent using [Daily](https://daily.co) (the creators of Pipecat) and will deploy this app on Cerebrium to show how it handles deploying and scaling our app seamlessly.
...
In your IDE, run the following command to create our Cerebrium starter project: `cerebrium init realtime-agent`. This creates two files:
