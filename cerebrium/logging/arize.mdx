...
Once you have signed up for Arize, you will need to create a 'space' - you can think of this a a way to organize various models but usually one space per company/client is sufficient. 
...
If you would like to be be more familiar with their platform you can take a look at the [Arize documentation](https://arize.com/docs/).
