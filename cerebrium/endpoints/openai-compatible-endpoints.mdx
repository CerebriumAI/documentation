...
We recommend you checkout a full example of how to deploy a OpenAI compatible endpoint using vLLM [here](https://github.com/CerebriumAI/examples/tree/master/3-large-language-models/1-openai-compatible-endpoint)
