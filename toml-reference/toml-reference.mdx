...
This timeout only applies to app initialization during build. Request timeouts during inference are controlled by `response_grace_period` in the [scaling configuration](#scaling-configuration).
