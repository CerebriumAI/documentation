...
a autoregressive decoder and a diffusion decoder. Typically it takes a minute inference for 2 sentences, so if you are doing longer sentences we recommend you use the webhook functionality. 
