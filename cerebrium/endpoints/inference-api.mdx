...
All responses from Cerebrium endpoints include the following headers:

| Header       | Description                                                                                                                                                                                   |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| X-Request-Id | Represents the Cerebrium run ID, which is the same as the `run_id` included in the response body. This header is useful for tracking and correlating requests, especially in custom runtimes. |
