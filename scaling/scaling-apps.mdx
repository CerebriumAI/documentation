---
title: "Scaling Apps"
description: "Configure autoscaling for Cerebrium apps with min and max replicas, concurrency, and cooldown to balance cost, latency, and burst traffic performance."
---
