...
Thats it! You now have a fully functioning AI bot that can interact with a user through speech in ~500ms. Imagine the possibilities!
...
We created a public fork of the [PipeCat frontend](https://github.com/pipecat-ai/web-client-ui) in order to show you a nice demo of this application. You can clone the repo [here](https://github.com/CerebriumAI/web-client-ui).
