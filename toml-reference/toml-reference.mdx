...
| roll_out_duration_seconds | integer | 0                         | Duration of transition between revisions in seconds (0-600). Revisions are created after successful builds. Keep at 0 during development; lower values in production optimize cost and resources |
