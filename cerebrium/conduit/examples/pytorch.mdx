...
Install the Cerebrium framework by running the following command in your notebook
or terminal
...
You can run inference using `curl` or the `model_api_request`()` Python helper function. The helper function is useful for large data.
