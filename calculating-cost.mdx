...
description: Calculate GPU, CPU, and memory costs for Cerebrium deployments, including interruptible and 2x protected compute tier rates and per-second billing.
---
