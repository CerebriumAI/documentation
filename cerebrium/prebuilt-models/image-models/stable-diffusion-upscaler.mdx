...
<Note>Your image must be smaller than 510px x 510px and if not, please add a width and height parameter to resize it. It does a 4x upscale so you will get a 2000x200px image</Note>
