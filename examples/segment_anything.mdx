...
```bash
cerebrium deploy segment-anything --hardware AMPERE\_A5000 --api-key private-XXXXXXXXXXXXX
```
...
```
curl --location --request POST 'https://run.cerebrium.ai/v2/p-xxxxxx/segment-anything/predict' \
