...
ability to swap in a any LLM's or Text-to-speech (TTS) model of your liking. This is extremely useful for use cases involving voice such as customer support bots, receptionists and many more.
...
<Note>Docker files are not support yet but are rather in the works to be released soon. This is just a very early preview of how it would work.</Note>
