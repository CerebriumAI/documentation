...
We recommend you checkout a full example of how to deploy a OpenAI compatible endpoint using vLLM [here](https://github.com/CerebriumAI/examples/tree/master/4-large-language-models/5-openai-compatible-endpoint)
...
client = OpenAI(
    ...
    base_url="https://api.cortex.cerebrium.ai/v4/p-xxxxx/5-openai-compatible-endpoint/run", ##This is the name of the function you are calling
