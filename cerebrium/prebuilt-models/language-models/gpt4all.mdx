...
GPT4All is a 7B param language model that is fine-tuned from a curated set of 400k GPT-Turbo-3.5 assistant-style generation. You can read more [here](https://github.com/nomic-ai/gpt4all). In order to deploy gpt4all, you can use the identifier below:
