...
To see the final code implementation, you can view it [here](https://github.com/CerebriumAI/examples/tree/master/3-large-language-models/1-openai-compatible-endpoint)
