...
api: "POST https://run.cerebrium.ai/gpt4-all-webhook/predict"
---

GPT4All is a 7B param language model that is fine-tuned from a curated set of 400k GPT-Turbo-3.5 assistant-style generation. You can read more [here](https://github.com/nomic-ai/gpt4all). To deploy gpt4all, you can use the identifier below:
...
<ParamField body="num_beams" type="string" optional>
  The larger the beam size the higher the likelihood of finding a better
  solution but it also increases the computational complexity and inference
  time.
</ParamField>
