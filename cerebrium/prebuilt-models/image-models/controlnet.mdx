...
We also provide support for custom Dreambooth models that are hosted on Hugging Face. If you would like help on how to train and deploy your model you can read our blog post [here](https://blog.cerebrium.ai/creating-avatarai-me-using-supabase-and-cerebrium-1bf69440c4a7).
...
<ParamField body="prompt" type="string" required>
   The prompt you would like the Xontrolnet model to generate.
</ParamField>
<ParamField body="model" type="string" required>
   At the moment we only support two control net models. Canny Edge detection "canny" and Open Pose "openpose". We will add support for the other models shortly.
</ParamField>
