...
<Note>
<<<<<<< HEAD
If 'disable_auth' in your cerebrium.toml is set to false, use the inference token in your Authorization header in order to
authenticate with your Cerebrium service. Don't worry about the Deepgram API key, it will be pulled automatically from your secrets.
=======
  If 'disable_auth' in your cerebrium.toml is set to false, you need to use your
  inference token in your Authorization header in order to authenticate with
  your Cerebrium service. Don't worry about the Deepgram API key, we
  automatically pull that from your secrets.
>>>>>>> fd3089e7c9368a0ec419b20046d90a3d3ed61aec
</Note>
