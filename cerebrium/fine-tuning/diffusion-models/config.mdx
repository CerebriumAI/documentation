...
| api-key         | Your private API key           | Your Cerebrium API key. Can also be retrieved if you have run `cerebrium login`      |
...
name: "test-config-file" # Name of the experiment.
api-key: "YOUR PRIVATE CEREBRIUM API KEY" # Your Cerebrium API key.
