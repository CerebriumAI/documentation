...
In some cases, you may need to parse additional parameters to your pipeline. Say your model is too large and so you need to offload the model, load in 8bit. Additionally, access to the model requires your authorization token. Normally, when using the huggingface libraries, you would do this as follows:  
```python
