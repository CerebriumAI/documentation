...
With the introduction of one-off jobs, you can harness the same GPU capabilities available in Cortex deployments for a variety of tasks. Whether you're focused on training, data processing, downloading large model weights, or handling one-off runs, our platform ensures efficiency and ease across diverse use cases.
