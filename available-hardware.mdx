...
_Due to the global shortage of GPUs at the moment, we may not always have the Enterprise edition of your GPU availible. In this case, we will deploy to the Workstation edition of the GPU._  
...
As a rule of thumb, the easier way is to choose the hardware that has at least 1.5x the minimum amount of VRAM that your model requires.
