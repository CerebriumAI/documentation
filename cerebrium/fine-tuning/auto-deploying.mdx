...
_Keep in mind that the values for `autodeploy-requirements-file` and `autodeploy-pkglist-file` are the paths to the files on your local machine. These files will be uploaded to the Cerebrium platform and used in your deployment._
