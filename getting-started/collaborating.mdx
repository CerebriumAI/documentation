...
Once members accept their invitations, they gain immediate access based on their assigned roles and can access their authorized project(s) from the dashboards.
