...
autodeploy:
  ...
  autodeploy-requirements-file: /Path/To/Your/requirements.txt # Optional requirements.txt
  autodeploy-pkglist-file: /Path/To/Your/pkglist.txt # Optional pkglist.txt
```

_While we've tried to include all the requirements your model may need. You can overwrite our defaults by providing files for `autodeploy-requirements-file` and `autodeploy-pkglist-file`. This is particularly useful if you want to use a specific version of a library or find you want to include an extra package._
