...
GitHub Actions uses workflow files located in the `.github/workflows/` directory of your repository. You’ll need to create one to define your deployment process.

1. In the root of your GitHub repository, create the directory `.github/workflows` if it doesn’t already exist.
...
Once committed, this workflow will automatically :
	•	On every push to master it will deploy your production application
	•	On pull requests to master or development it will deploy to your development app.
	•	When manually triggered from the GitHub UI (under the “Actions” tab)
