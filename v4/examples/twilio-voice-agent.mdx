...
For lower latency (~500ms end-to-end), run parts or all of the pipeline locally. Learn more in our [voice agents guide](/v4/examples/realtime-voice-agents) and [RAG voice agent blog post](https://www.cerebrium.ai/blog/creating-a-realtime-rag-voice-agent).
