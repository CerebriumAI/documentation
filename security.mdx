...
Cerebrium is SOC 2 Type I compliant that means we enforce certain security standards and protocols. Our compliance is continually monitored through Vanta. Please reach out to security@cerebrium.ai if you would like more information regarding our security compliance and implementations.
...
- Clients can initiate the BAA process by contacting compliance@cerebrium.ai.
...
- Clients are responsible for de-identifying PHI before transmission to Cerebrium's systems, if de-identification is required for their use case.
