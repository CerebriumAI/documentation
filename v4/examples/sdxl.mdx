...
<Note>
  This example is only compatible with CLI v1.20 and later. If you're using an
  older version of the CLI, run `pip install --upgrade cerebrium` to upgrade it
...
View the final implementation [here](https://github.com/CerebriumAI/examples/tree/master/7-image-and-video/3-sdxl-refiner)
