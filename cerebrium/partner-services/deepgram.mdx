...
<Note>
If 'disable_auth' in your cerebrium.toml is set to false, you need to use your inference token in your Authorization header in order to
authenticate with your Cerebrium service. Don't worry about the Deepgram API key, we automatically pull that from your secrets.
</Note>
