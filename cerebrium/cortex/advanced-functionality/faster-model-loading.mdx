...
[Pytorch Lightning's fabric](https://lightning.ai/docs/fabric/latest/) is a library that utilises the optimisations in *Pytorch Lightning* but at higher level.  
...
<Note>
Serialising with Pytorch Lightning's fabric is memory intensive so make sure your deployment has the same amount of memory as your model size.
</Note>
