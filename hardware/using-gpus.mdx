---
title: Using GPUs
description: Select GPUs for Cerebrium apps, configure compute preference lists, and pick the right hardware family for cost, throughput, and cold start needs.
---
