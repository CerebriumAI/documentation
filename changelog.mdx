...
- Fixed a bug that caused the ONNX runtime to only use the CPUProvider. You should upgrade to this version if you are using ONNX models that use GPU computation.
