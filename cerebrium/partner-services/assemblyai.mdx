...
<Note>
  The above disables auth meaning anyone can make requests to your endpoint. If you set disable_auth=false, then
  you need to use the API key from your Cerebrium Dashboard.
  key
</Note>
