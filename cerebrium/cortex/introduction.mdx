...
We recommend you check out the [advanced functionality](/cerebrium/cortex/advanced-functionality) section of Cortex as well as work through the [examples](/coretex/examples) to see how deployments were done for various different applications.
