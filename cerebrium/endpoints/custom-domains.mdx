...
<Note>
  DNS record details can also be found later by clicking "DNS Record" in
...
3. To trigger an immediate validation attempt, click "Validate Domain" next to the domain, even after the 2 days have elapsed
