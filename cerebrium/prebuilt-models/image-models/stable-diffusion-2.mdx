...
<ParamField body="webhook_endpoint" type="string" optional>
   The url endpoint you would like us to send the image results to once it has finished generating. We recommend this for long running tasks if you are generating
   multiple images with many steps.
</ParamField>
