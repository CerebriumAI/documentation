...
```
<Note>
If you'd like to use objects across multiple functions, consider using our (persistent memory store)[/cerebrium/advanced-functionality/persistent-memory] feature.
</Note>
