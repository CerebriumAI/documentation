...
<Note>
    ...
    reach out to us on Slack or Discord
</Note>

Here is an example on how to add a webhook endpoint to your request body:
...
The response from your initial request will look something like this
...
<Note>
    Make sure that the endpoint provided as the "webhook_endpoint" is able to handle POST requests and has the
    appropriate settings to receive the response data.
</Note>