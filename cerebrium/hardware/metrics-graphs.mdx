...
- Spikes in this graph often correlate with increased latency in your app
- If this value consistently remains high, consider increasing your replica count or adjusting your scaling configuration
- Zero values don't necessarily mean your app isn't receiving traffic - it could mean requests are being processed immediately without queuing
