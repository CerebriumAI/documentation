...
Awesome! Lets start creating ML-based applications

## How to navigate our documentation

Cerebrium caters to many different types of businesses and users that we have create abstractions that suit different users in different situations. Based on your use-case we recommend you look at the starting points below and examples in each sub-directory.

<CardGroup>
<Card
  title="Cortex"
  href="/cortex/introduction"
>
...
<Card
  title="Conduit"
  href="/conduit/introduction"
>
  You have a model file or Hugging Face model ID and just want to turn it into a API endpoint. 
</Card>

<Card
  title="Prebuilt models"
  href="/prebuilt-models/custom"
>
