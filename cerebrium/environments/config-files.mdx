...
| `python_version` | The Python version available for your runtime | float | {interpretor_version}|
...
| `gpu` | The GPU you would like to use. | string | AMPERE_A10 |
...
| ------------------ | ---------------- | ----------------- |
| `CPU`              | [coreweave, aws] | [v4]              |
| `TURING_4000`      | [coreweave]      | [v3]              |
| `TURING_5000`      | [coreweave]      | [v3]              |
| `AMPERE_A4000`     | [coreweave]      | [v3]              |
| `AMPERE_A5000`     | [coreweave]      | [v3]              |
| `AMPERE_A6000`     | [coreweave]      | [v3]              |
| `AMPERE_A10`       | [aws]            | [v4]              |
| `ADA_L4`           | [aws]            | [v4]              |
| `AMPERE_A100`      | [coreweave, aws] | [v3, v4]          |
| `AMPERE_A100_40GB` | [coreweave, aws] | [v3]              |
| `HOPPER_H100`      | [coreweave, aws] | [v4]              |
| `INF2`             | [aws]            | [v4]              |
| `TRN1`             | [aws]            | [v4]              |
