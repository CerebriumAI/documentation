---
title: "Changelog"
description: "We release features and fixes regularly! See some of the changes we have made."
---
...
- Updated CUDA runtime from 11.3 to CUDA 11.6.
...
- Bug fixes:
  ...
  - Fixed CUDA driver not being loaded correctly in the Conduit runtime.
- LLM updates:
...
- Added more models to our pre-built library:
  - mt0-xl
  - galactica
  - flan-xl
...
- Added pre-built models to available deployments:
  - whisper-medium
...
- Fixed a bug where the internal flow would be malformed if the model was not
  ONNX.
- Forced single model ONNX flow until post-processing is supported.
...
- Reduced the minimum Python version to 3.7 (and reduced dependency min versions
...
- Updated license.
- Added handling for usage limits on different Cerebrium packages.

## v0.1.4

#### Date: 16 October 2022

- Released on the public PyPI.
...
- Support PyTorch, XGBoost, and scikit-learn models.
...
- Added ability for users to deploy models from their notebooks or .py files with just 4
  lines of code.
