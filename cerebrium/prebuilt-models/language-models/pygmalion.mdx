...
```bash Request
  curl --location --request POST 'https://run.cerebrium.ai/pygmalion-2-7b-webhook/predict' \
      ...
      --data-raw '{
        "prompt": "Michaels'\''s Persona: A big strong man with a big heart\n<START>\nYou: How are you doing on this wonderful day?\n Michael:"",
        "max_length": 100,
        "temperature": 0.5"
        "stopping_criteria"=["The end."],
        "max_new_tokens"=100, 
        "top_p"=0/5,
        "typical_p"=0.9,
...
<ParamField body="max_length" type="string">
...
<ParamField body="stopping_criteria" type="list">
   A list of words/phrases that can be used to change when to stop generation.
</ParamField>
<ParamField body="max_new_tokens" type="integer">
   The max number of new tokens you would like the model to generate. This is different from max length as it excludes the prompt you entered.
</ParamField>
...
<ParamField body="pad_token_id" type="integer">
...
<ResponseField name="messave" type="string" required>
