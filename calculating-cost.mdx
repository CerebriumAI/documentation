...
2. The model runtime. This is the amount of time it takes your code to run from start to finish. Its important for you to remember Cerebrium does not charge you for
 cold starts only each runtime.
...
- 2 CPU cores: $0.0000532 * 2 per second
- 20GB Memory: $0.00000659 * 20 per second
- 10 GB persistent storage: $0.23 * 10 per month

Your model works on the first deployment and so you incur only one build process of 2 minutes and the model has a average runtime of 2 seconds. Let us calculate your
