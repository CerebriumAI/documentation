...
We don't require any linux packages so we can keep our pkglist.txt empty but lets make sure we instal the required Python packages in our requirements.txt
