...
<Note>
  In order to use Deepgram services, you need to have a Enterprise Deepgram account and an API key in order to use their self-hosted models. Please contact Deepgram support to get access to this feature.
</Note>
<Note>
