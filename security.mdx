...
description: "Cerebrium has invested time to make sure we follow security best practice"
---
...
- Cerebrium frequently perform vulnerabilities scans and these vulnerabilities are remediated based on the time frame set out in our .
- Cerebrium conduct annual business continuity and security incident exercises. This is a requirement in order to remain SOC 2 compliant.
