...
**Contents**:
- [Setting up your dataset](#setting-up-your-dataset)
...
- images should be upright or in the same orientation.
...
- Try fine-tuning a single style at a time. Keep the style consistent across all of your images.
Additionally, try to keep your colouring consistent.
...
The following is the file structure that Cerebrium expects for your dataset:
```
training_dataset/
├── image0.jpg
├── image1.jpg
...
├── image3.jpg
```
Where your files can be in any of the following formats: 
- jpg
- png
- jpeg
