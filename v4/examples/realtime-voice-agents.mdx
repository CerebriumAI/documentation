...
Find the final version of the code [here](https://github.com/CerebriumAI/examples/tree/master/6-voice/2-realtime-voice-agent)
...
<Note>
  You need a Deepgram Enterprise License to deploy Deepgram on Cerebrium.
  Otherwise, use their API endpoint below.
</Note>
...
Run yarn dev and go to the URL: http://localhost:5173/ to test your application.
