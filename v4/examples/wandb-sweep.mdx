...
To train with Llama 3.2, you need:
...
Read a deeper explanation of the training script [here](https://www.datacamp.com/tutorial/fine-tuning-llama-3-2). Here's a high-level explanation of the code in bullet points:
