...
<Info>
  ...
  over the `CMD` or `ENTRYPOINT` instruction in your Dockerfile. If you specify an `entrypoint`
  in your TOML configuration, it will be used regardless of what `CMD` or `ENTRYPOINT` is
