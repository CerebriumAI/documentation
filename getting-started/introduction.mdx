...
If your account belongs to multiple projects, switch the CLI's active project with:

```bash
cerebrium project set <PROJECT_ID>
```

Find the project ID on the [Cerebrium dashboard](https://dashboard.cerebrium.ai/).
