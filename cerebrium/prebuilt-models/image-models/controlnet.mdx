...
api: "POST https://run.cerebrium.ai/controlnet-webhook/predict"
---
...
<ParamField body="hf_token" type="string" optional>
   This is the token from your HuggingFace profile to access your model repo. This is a required parameter if you enter a model id that is private.
</ParamField>
