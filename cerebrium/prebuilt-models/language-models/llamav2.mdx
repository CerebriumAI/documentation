...
on 40% more tokens, having a much longer context length (4k tokens 🤯), and using grouped-query attention for fast inference of the 70B model. You can read
To deploy gpt4all, you can use the identifier below:

- Llama2 7b: `llamav2-7b`
- Llama2 7b Chat: `llamav2-7b`
