...
| deployment_initialization_timeout | integer  | 600 (10 minutes)       | Max time to wait for app initialization during build before timing out. Value must be between 60 and 7200 |
