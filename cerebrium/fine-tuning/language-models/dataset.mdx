...
Due to the much lower number of trainable parameters, the datasets used do not need to be greater than 1000 examples. Often, much smaller datasets of 200-500 examples are more than sufficient, however, it's always best to use as many diverse training examples as possible to cover a wide variety of use cases.
...
For your convenience, an example dataset has been provided for testing [here](#example-dataset). The dataset is
