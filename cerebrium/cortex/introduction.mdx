...
To deploy a model, navigate to where your model code (specifically your `main.py`) is located and run the following command:

```bash
cerebrium deploy <MODEL_NAME> <PRIVATE_API_KEY> -h=<HARDWARE>
```
