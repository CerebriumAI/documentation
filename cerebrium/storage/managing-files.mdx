...
1. **Via Dashboard**: Navigate to your project and select **Volumes**. Click the three-dot menu on your volume and select **Increase Size**.

<Frame>
  <img src="/images/storage-volume-resize.png" alt="Volume resize option in the Cerebrium dashboard" />
</Frame>
...
<Note>
  For storage needs beyond 1TB, please contact support on
...
2. Resize your volume to a larger capacity (up to 1TB self-service)
