---
title: "Persistent Memory in Conduit Processing Functions"
---
...
The persistent memory store is a global store, meaning that all functions in the pipeline can access the same data. However, while you can save any Python object,
