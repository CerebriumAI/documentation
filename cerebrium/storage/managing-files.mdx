...
<Note>
  Self-service resizing supports volumes between 50GB and 100GB. For storage needs beyond 100GB, 
  please reach out to us through [support](mailto:support@cerebrium.ai).
</Note>
